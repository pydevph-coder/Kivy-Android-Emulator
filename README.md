...
- [Download the latest APK from Releases](https://github.com/yourusername/live-code-emulator/releases)
- Or build from source with [Buildozer](https://github.com/kivy/buildozer)

### 2. Desktop Listener

- Download and run the companion listener:
  - Windows: `listener-win.exe` (coming soon)
  - Linux: `listener-linux` (planned)
  - macOS: `listener-mac` (planned)
...
- [Full Docs](./docs)
- [Buildozer Setup](./docs/buildozer_setup.md)
...
We welcome contributors! Please read our [contributing guidelines](./CONTRIBUTING.md) to get started.
...
Open an issue or email us at: [pydevph@gmail.com](mailto:pydevph@gmail.com)

---

> _Live Code Emulator: The fastest way to see your code in action on Android!_
